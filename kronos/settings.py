...
BRAND_LOGO = properties["GENERAL"]["BRAND_LOGO"]
BRAND_ADDRESS = properties["GENERAL"]["BRAND_ADDRESS"]
BRAND_GSTIN = properties["GENERAL"]["BRAND_GSTIN"]
...
EMAIL_SWITCH = {
    ...
    "CLIENT_VERIFICATION_EMAIL": properties["EMAIL_SWITCH"]["CLIENT_VERIFICATION"] == "True",
    ...
    "QA_PENDING_NOTIFICATION_EMAIL": properties["EMAIL_SWITCH"]["QA_PENDING_NOTIFICATION_EMAIL"] == "True",
    "MAX_EMAIL_SENT_COUNT": properties["EMAIL_SWITCH"]["MAX_EMAIL_SENT_COUNT"],
}

MESSAGE_SWITCH = {
    "NOTIFICATION_MESSAGE": properties["MESSAGE_SWITCH"]["NOTIFICATION"] == "True",
    "OPPORTUNITY_MESSAGE": properties["MESSAGE_SWITCH"]["OPPORTUNITY"] == "True"
}

MSG91_FLOW_IDS = {
    "AUDIT_OPPORTUNITY": properties["MSG91_FLOW_IDS"]["AUDIT_OPPORTUNITY"],
}
...
MSG91 = {
    ...
    'MAX_SMS_SENT_COUNT': properties["MSG91"]["MAX_SMS_SENT_COUNT"],
}
...
PAYOUT_SWITCH = properties['PAYOUTS']['PAYOUT_SWITCH']
PAYOUT_DEFAULT_ADDRESS = properties['PAYOUTS']['PAYOUT_DEFAULT_ADDRESS']

MESSAGEBIRD_SIGNING_KEY = properties['MESSAGEBIRD']['SIGNING_KEY']
MESSAGEBIRD_ACCESS_KEY = properties['MESSAGEBIRD']['ACCESS_KEY']
MESSAGEBIRD_CHANNEL_ID = properties['MESSAGEBIRD']['CHANNEL_ID']
MESSAGEBIRD_NAMESPACE = properties['MESSAGEBIRD']['NAMESPACE']
MESSAGEBIRD_SWITCH = properties['MESSAGEBIRD']['MESSAGEBIRD_SWITCH'] == "True"
MAX_WHATSAPP_SENT_COUNT = properties['MESSAGEBIRD']['MAX_WHATSAPP_SENT_COUNT']

WHATSAPP_TEMPLATE = {
    'AUDIT_OPPORTUNITY': properties['WHATSAPP_TEMPLATE']['AUDIT_OPPORTUNITY'],
    'AUDIT_ASSIGNED': properties['WHATSAPP_TEMPLATE']['AUDIT_ASSIGNED'],
    'AUDIT_ASSIGNED_PDF': properties['WHATSAPP_TEMPLATE']['AUDIT_ASSIGNED_PDF'],
    'AUDIT_ASSIGNED_PDF_AUDIO': properties['WHATSAPP_TEMPLATE']['AUDIT_ASSIGNED_PDF_AUDIO'],
    'AUDIT_REVERT_WITH_PROOF': properties['WHATSAPP_TEMPLATE']['AUDIT_REVERT_WITH_PROOF'],
    'AUDIT_REVERT_WITHOUT_PROOF': properties['WHATSAPP_TEMPLATE']['AUDIT_REVERT_WITHOUT_PROOF']
}

RAZORPAY_SWITCH = properties['RAZORPAY']['SWITCH'] == "True"
RAZORPAY_ACCESS_KEY = properties['RAZORPAY']['ACCESS_KEY']
RAZORPAY_SECRET_KEY = properties['RAZORPAY']['SECRET_KEY']
MINIMUM_PAYMOUNT_AMOUNT = properties['RAZORPAY']['MINIMUM_PAYMOUNT_AMOUNT']
RAZORPAY_PAYMENT_GST = properties['RAZORPAY']['PAYMENT_GST']
RAZORPAY_MERCHANT_LOGO = properties['RAZORPAY']['MERCHANT_LOGO']


MARKET_PLACE_SWITCH = properties['MARKET_PLACE_RAZORPAY']['SWITCH'] == "True"
MARKET_PLACE_RAZORPAY_ACCESS_KEY = properties['MARKET_PLACE_RAZORPAY']['ACCESS_KEY']
MARKET_PLACE_RAZORPAY_SECRET_KEY = properties['MARKET_PLACE_RAZORPAY']['SECRET_KEY']

CLIENT_QUOTATION_GST = properties['CLIENT_QUOTATION']['GST']