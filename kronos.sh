...
gunicorn --error-logfile ./logs/gunicorn.err.log --access-logfile ./logs/gunicorn.access.log --log-level debug --workers 4 --bind 0.0.0.0:8000 -p ./logs/gunicorn.pid --statsd-host=localhost:8125 -D kronos.wsgi
