...
def audit_cycle_image_upload_by_audit_cycle_id(audit_cycle_id,file_name,file_size,mime_type):
    audit_cycle = audit_cycle_service.find_by_id(audit_cycle_id)
    return attachment_service.upload_for_audit_cycle(audit_cycle_id,file_name,file_size,mime_type)
