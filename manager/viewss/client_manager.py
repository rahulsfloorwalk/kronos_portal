...
class DashboardWidgetAccessSerializer(ModelSerializer):
    ...
    def deserialize(self):
        ...
        widget_access.overall_audit_cycle_score = self.validated_data.get('overall_audit_cycle_score',widget_access.overall_audit_cycle_score)
        ...
        widget_access.city_wise_performance = self.validated_data.get('city_wise_performance',widget_access.city_wise_performance)
        widget_access.store_wise_performance = self.validated_data.get('store_wise_performance',widget_access.store_wise_performance)
