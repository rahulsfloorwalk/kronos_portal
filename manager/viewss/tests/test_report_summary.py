...
class AuditStoreIdReportSummaryViewTestCase(APITestCase):
    ...
    def create_acceptable_report(self):
    ...
    def test_set_report_summary_sets_report_summary(self):
        audit_store = self.create_acceptable_report()
        self.login()
        ...
        response = self.client.post(reverse("manager:audit_store_id_report_summary_view", kwargs={
