...
class ClientProfileSerializer(ModelSerializer):
    class Meta:
        ...
        fields=('id','company_name','first_name','last_name','mobile_number')
...
class ClientProfileDeSerializer(ModelSerializer):
    ...
    def deserialize(self):
        ...
        try:
            profile_info = MPClientProfileInfo.objects.get(user_id=self.context['current_user'].id)
...
class ClientProfileView(APIView):
    ...
    def post(self,request):
        profile_info_ds = ClientProfileDeSerializer(data=request.data, context={'current_user': request.user})
