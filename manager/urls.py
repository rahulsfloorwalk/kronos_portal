...
urlpatterns = ([
    ...
    url(r'client/(?P<client_id>[0-9]+)/audit_cycle/(?P<audit_cycle_id>[0-9]+)/audit_cycle_xlsx_report$', audit_cycle_views.AuditCycleXlsxReport.as_view(), name='audit_store_xlsx_report'),
