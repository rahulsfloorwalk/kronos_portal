...
urlpatterns = ([
    ...
    url(r'audit_cycle/(?P<audit_cycle_id>[0-9]+)/city/(?P<city_id>[0-9]+)/check_eligibility_auditors$', audit_cycle_views.CheckEligibilityOfAuditorView.as_view(), name='check_eligibility_auditor_view'),
