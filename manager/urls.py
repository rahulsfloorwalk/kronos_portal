...
urlpatterns = ([
    ...
    url(r'audit_store/(?P<audit_store_id>[0-9]+)/attachment/(?P<attachment_id>[0-9]+)/highlight$', attachment_views.AuditStoreAttachmentHighlightView.as_view(), name='audit_store_attachment_highlight_view'),
    ...
    url(r'audit_store/(?P<audit_store_id>[0-9]+)/section/(?P<section_id>[0-9]+)/attachment/(?P<attachment_id>[0-9]+)/highlight$', attachment_views.AuditStoreSectionAttachmentHighlightView.as_view(), name='audit_store_attachment_highlight_view'),
    url(r'audit_store/(?P<audit_store_id>[0-9]+)/section/(?P<section_id>[0-9]+)/attachment_comments$', attachment_views.ReportSectionAttachmentCommentView.as_view(), name='report_section_attachment_comments_view'),
    ...
    # url(r'audit_cycle/(?P<audit_cycle_id>[0-9]+)/audit_store_city_list$', audit_store_views.AuditStoreCityListByAuditCyclewise.as_view(), name='audit_store_city_list_by_audit_cycle_view'),
    ...
    # url(r'audit_cycle/(?P<audit_cycle_id>[0-9]+)/user_list_for_reports_filter$', audit_store_views.UserListForReportsFilterwise.as_view(), name='user_list_for_reports_filter_view'),
    ...
    url(r'client_moderator_insert$', client_manager_views.ClientModeratorView.as_view(), name='client_moderator_view'), # insert
    # url(r'client/(?P<client_id>[0-9]+)/client_moderator$', client_manager_views.ClientModeratorByClientView.as_view(), name='client_moderator_view_by_client'), # get list
    url(r'client/(?P<client_id>[0-9]+)/client_moderator$', client_manager_views.ClientModeratorByClientwiseView.as_view(), name='client_moderator_view_by_client'), # get list
    url(r'client_moderator/(?P<client_moderator_id>[0-9]+)$', client_manager_views.ClientModeratorIdView.as_view(), name='client_moderator_id_view'), # get and post by id 
    url(r'client/(?P<client_id>[0-9]+)/client_moderator_assign$', client_manager_views.ClientModeratorAssignView.as_view(), name='client_moderator_assign_view'), # non assignd moderator
    url(r'client/(?P<client_id>[0-9]+)/dashboard_widget_visibility_access$', client_manager_views.ClientDashboardWidgetVisibilityAccessView.as_view(), name='client_dashboard_widget_visibility_access_view'), # non assignd moderator
