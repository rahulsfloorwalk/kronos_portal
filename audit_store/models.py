            ...
            if not report_section.not_applicable:
                ...
                for answer in answers:
                   ...
                   # # if not answer.question.question_type == Question.MULTISELECT:
                    ...
                    #         _logger.debug("Report not submittable, some answer is incomplete")
                    #         return False
                    # if answer.question.optional_comment_required is False and answer.question.max_marks ==0 and answer.question.question_type == Question.MUTEX and (answer.answer_comment is None or answer.answer_comment.strip() == ''):
                    #     return True
