...
urlpatterns = ([
    ...
    url(r'dashboard/questionnaire_type/(?P<questionnaire_type_id>[0-9]+)/store$', views.DashboardStoreTrends.as_view(), name='dashboard_store_trends'),
    url(r'dashboard/questionnaire_type/(?P<questionnaire_type_id>[0-9]+)/store_xlsx$', views.DashboardStoreTrendsXlsx.as_view(), name='dashboard_store_trends_xlsx'),
    url(r'dashboard/questionnaire_type/(?P<questionnaire_type_id>[0-9]+)/city$', views.DashboardCityWiseTrends.as_view(), name='dashboard_city_trends'),
    url(r'dashboard/questionnaire_type/(?P<questionnaire_type_id>[0-9]+)/city_xlsx$', views.DashboardCityWiseTrendsXlsx.as_view(), name='dashboard_city_trends_xlsx'),
    ...
    url(r'report/store/(?P<store_id>[0-9]+)/marking_graph', views.MarkingGraphByStore.as_view(), name='marking_graph_by_store'),
