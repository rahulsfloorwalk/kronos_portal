...
urlpatterns = ([
    ...
    url(r'forgot_password/success$', view_log(password_reset_done), {
        'template_name': 'registration/forgot_password_success.html'
        }, name="password_reset_done"),

    url(r'forgot_password/reset/(?P<uidb64>.+)/(?P<token>.+)$', view_log(password_reset_confirm), {
        'template_name': 'registration/password_reset_confirm2.html',
        'post_reset_redirect': 'registration:password_reset_complete'
        }, name="password_reset_confirm"),

    url(r'forgot_password/complete$', view_log(password_reset_complete), {
