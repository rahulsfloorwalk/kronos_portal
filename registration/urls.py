...
urlpatterns = ([
    ...
    url(r'client/old_login$', client_views.Old_Login.as_view(), name="client_old_login"),
    ...
    url(r'old_auditor_login$', views.Old_auditor_Login.as_view(), name="old_auditor_login"),
    url(r'old_auditor_signup$', views.Old_auditor_SignUp.as_view(), name="old_auditor_signup"),
