...
class AuditStoreEarningsPerAuditView(APITestCase):
    fixtures = ['groups']
    ...
    def test_post_sets_earnings_per_audit(self):
        ...
        response = self.client.post(reverse('moderator:audit_store_id_earnings_per_audit_view', kwargs = {
