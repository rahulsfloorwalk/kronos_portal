from django.db.models import Model, CharField, AutoField, ForeignKey, PositiveIntegerField, IntegerField, BooleanField
...
class Section(Model):
    ...
    hide_comment = BooleanField(db_column='hide_comment', default=False)
