...
class AuditCycleTestCase(TestCase):
    ...
    def test_trendable_status_matches_negative_snapshot(self):
    ...
    def test_live_reporting_status_matches_negative_snapshot(self):
        all_statuses = set(AuditCycle.ALL_STATUSES)
    ...
    def test_moderator_visible_status_matches_negative_snapshot(self):
        all_statuses = set(AuditCycle.ALL_STATUSES)
    ...
    def test_moderator_modifiable_status_matches_negative_snapshot(self):
        all_statuses = set(AuditCycle.ALL_STATUSES)
    ...
    def test_auditor_visible_status_matches_negative_snapshot(self):
        all_statuses = set(AuditCycle.ALL_STATUSES)
    ...
    def test_agency_visible_status_matches_negative_snapshot(self):
        all_statuses = set(AuditCycle.ALL_STATUSES)
