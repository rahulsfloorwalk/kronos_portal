...
def send_audit_report_concern_email(email_address, audit_store_id, user_profile_info, message):
    ...
    subject = "Auditor has concern about - {} - {} audit".format(params['client_name'], params['store_name'])
