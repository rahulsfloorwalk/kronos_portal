...
class SectionIdViewTestCase(ClientAPITestCase):
    ...
    def test_get_retrieves_section(self):
        ...
        response = self.client.get(reverse('client_rest_v1:section_id_view', kwargs = {
    ...
    def test_post_updates_a_section(self):
        ...
        response = self.client.post(reverse('client_rest_v1:section_id_view', kwargs = {
            'section_id': section.id,
        }), post_data)
    ...
    def test_delete_deletes_a_section(self):
        ...
        response = self.client.delete(reverse('client_rest_v1:section_id_view', kwargs = {
            'section_id': section.id,
        }))
...
class SectionViewTestCase(ClientAPITestCase):

    def test_post_creates_a_section(self):
        self.login()

        audit_cycle = mommy.make(AuditCycle, client = self.client_obj, created_by_client = True)
        ...
        response = self.client.post(reverse('client_rest_v1:section_view'), post_data)
