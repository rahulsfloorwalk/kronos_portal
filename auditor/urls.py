...
urlpatterns = ([
    ...
    url(r'audit_store/(?P<audit_store_id>[0-9]+)/submit$', views.AuditStoreIdSubmitReportView.as_view(), name="audit_store_id_submit_view"),
    ...
    url(r'audit_store/(?P<audit_store_id>[0-9]+)/question/(?P<question_id>[0-9]+)/not_applicable$', views.AnswerNotApplicableView.as_view(), name='answer_not_applicable_view'),
    ...
    url(r'app/resend_otp_api$', views_api.ResendOtpAPI.as_view(), name="resend_otp_api"),
