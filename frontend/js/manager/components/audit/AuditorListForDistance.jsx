...
class AuditorListForDistance extends Component {
	static propTypes = {
	...
	reloadDistanceAuditorList = (auditCycleId, storeId) => {
		this.setLoading(true);
		findDistanceAuditorByPresenceInStoreId(auditCycleId, storeId).then((auditors) => {
			this.setState({ distanceAuditors: auditors.nearest_auditors });
...
export default connect(mapStoreToProps)(withRouter(AuditorListForDistance));