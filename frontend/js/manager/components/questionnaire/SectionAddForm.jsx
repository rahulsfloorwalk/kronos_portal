		...
		return (
			<Modal modalTitle="Add Section" onClose={this.props.router.goBack}>
				<form onSubmit={this.onSubmit}>
					...
					<FormInput label="Hide Section Comment" type="checkbox" name="hide_comment" onChange={this.inputChanged} style={{verticalAlign:"bottom",width:"20px",height:"20px"}} errors={this.props.errors.hide_comment}/>
					<SaveButton/>&nbsp;
