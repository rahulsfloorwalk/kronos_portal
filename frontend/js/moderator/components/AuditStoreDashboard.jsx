		...
		return(
			<div className="panel panel-default">
				<div className="panel-heading">
					<h4 className="">{this.props.auditStores.length} Reports</h4>
				</div>
...
export default class AuditStoreDashboard extends Component {
	...
	render(){
		if(this.props.location.query.type === "qa_done"){
			return <AuditStoreList2 auditStores={this.state.qa_done}/>;
		} else {
			return <AuditStoreList2 auditStores={this.state.qa_pending}/>;
		}
	}
}
