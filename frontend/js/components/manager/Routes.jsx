...
import AuditStoreForm from './AuditStoreForm.jsx';
...
const Routes = () => (
	...
	<Route path="/" component={App}>
      ...
      <Route path="audit_store/add" component={AuditStoreForm}/>
			<Route path="audit_store/:auditStoreId/edit" component={AuditStoreForm}/>
		</Route>
