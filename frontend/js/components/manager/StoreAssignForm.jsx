...
import { fetchStore, updateStore } from '../../manager/actions/store.js';
import { assignStoreToClientUser, revokeStoreFromClientUser } from '../../manager/service/store.js';

import { Checked, Unchecked } from '../Icons.jsx';
