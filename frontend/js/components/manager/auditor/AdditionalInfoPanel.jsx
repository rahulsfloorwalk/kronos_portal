...
import { fetchAdditionalInfoForAuditor } from '../../../manager/service/auditor.js'
...
export default React.createClass({
	...
	render: function(){
		...
		var weekend_audit = this.state.additionalInfo.weekend_audit ? <Check/> : <Cross/>;
		var camera_owned = this.state.additionalInfo.camera_owned ? <Check/> : <Cross/>;
		var smart_phone_owned = this.state.additionalInfo.smart_phone_owned ? <Check/> : <Cross/>;
