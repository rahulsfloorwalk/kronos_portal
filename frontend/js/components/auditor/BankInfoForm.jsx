		...
		return (
			<Modal modalTitle="Edit Bank Info" onClose={hashHistory.goBack}>
				<form onSubmit={this.onSubmit}>
					<FormInput label="Bank Name" maxLength="40" type="text" value={this.state.bank_name} name="bank_name" onChange={this.inputChanged}/>
					...
					<FormInput label="Account Number" maxLength="20" type="text" value={this.state.account_number} name="account_number" onChange={this.inputChanged}/>
					<FormInput label="IFSC Code" maxLength="20" type="text" value={this.state.ifsc_code} name="ifsc_code" onChange={this.inputChanged}/>
					<SaveButton/>
				</form>
			</Modal>
		);
