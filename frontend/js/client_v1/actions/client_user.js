...
export function fetchClientUsers(clientId){
	return function(dispatch){
		...
		return $.get( url.api_base_path + "client_v1/client_user", function(clientUsers){
			dispatch({
				type: types.CLIENT_USER_GET,
				status: "success",
				clientUsers
...
export function fetchClientUser(clientUserId){
	return function(dispatch){
		...
		return $.get( url.api_base_path + `client_v1/client_user/${clientUserId}`, function(clientUser){
			dispatch({
				type: types.CLIENT_USER_ID_GET,
				status: "success",
				clientUser
