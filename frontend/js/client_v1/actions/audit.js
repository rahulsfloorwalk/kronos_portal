...
import { fetchAuditCycles as _fetchAuditCycles } from "../service/audit_cycle.js";
...
export function fetchAuditCycles(){
	return function(dispatch){
		...
		return _fetchAuditCycles().done(function(auditCycles){
			dispatch({
				type: types.AUDIT_CYCLE_GET,
				status: "success",
				auditCycles
...
export function fetchAuditCycle(auditCycleId){
	return function(dispatch){
		...
		return $.get( url.api_base_path + `client_v1/audit_cycle/${auditCycleId}`, function(auditCycle){
			dispatch({
				type: types.AUDIT_CYCLE_ID_GET,
				status: "success",
				auditCycle
...
export function saveAuditCycleAddForm(auditCycle){
	return function(dispatch){
		...
		var req = $.ajax({
			type: "POST",
			url: url.api_base_path + "client_v1/audit_cycle",
...
export function saveAuditCycleEditForm(auditCycle){
	return function(dispatch){
		...
		var req = $.ajax({
			type: "POST",
			url: url.api_base_path + `client_v1/audit_cycle/${auditCycle.id}`,
			data: JSON.stringify(auditCycle),
			contentType: "application/json"
		});
		req.done(function(savedAuditCycle){
...
export function setPostApprovalDescription(auditCycleId, postApprovalDescription){
	return function(dispatch){
		let req = $.ajax({
			type: "POST",
			url: url.api_base_path + `client_v1/audit_cycle/${auditCycleId}/post_approval_description`,
			data: JSON.stringify({
...
export function setCheckPoints(auditCycleId, checkpoints){
	return function(dispatch){
		let req = $.ajax({
			type: "POST",
			url: url.api_base_path + `client_v1/audit_cycle/${auditCycleId}/checkpoints`,
			data: JSON.stringify({
...
export function hideAudit(audit_id){
	return function(dispatch){
		let req = $.ajax({
			type: "POST",
			url: url.api_base_path + `client_v1/audit/${audit_id}/hidden`,
		});
...
export function fetchAudits(auditCycleId){
	return function(dispatch){
		...
		return $.get( url.api_base_path + `client_v1/audit_cycle/${auditCycleId}/audit`, function(audits){
			dispatch({
				type: types.AUDIT_GET,
				status: "success",
				audits
...
export function fetchAudit(auditId){
	return function(dispatch){
		...
		return $.get( url.api_base_path + `client_v1/audit/${auditId}`, function(audit){
			dispatch({
				type: types.AUDIT_ID_GET,
				status: "success",
				audit
...
export function saveAuditAddForm(audit){
	return function(dispatch){
		...
		var req = $.ajax({
			type: "POST",
			url: url.api_base_path + "client_v1/audit",
...
export function saveAuditEditForm(audit){
	return function(dispatch){
		...
		var req = $.ajax({
			type: "POST",
			url: url.api_base_path + `client_v1/audit/${audit.id}`,
			data: JSON.stringify(audit),
			contentType: "application/json"
		});
		req.done(function(savedAudit){
...
export function deleteAudit(auditId){
	return function(dispatch){
		...
		let req = $.ajax({
			url: url.api_base_path + `client_v1/audit/${auditId}`,
			type: "DELETE"
		});
		req.done(function(){
			dispatch({
