...
import { King, Retweet, Inbox, Tasks, Pencil, Duplicate } from "../../../components/Icons.jsx";
		...
		return (
			<div>
				<ol className="breadcrumb">
					<li><Link to={`/projects/${this.props.auditCycle.client.id}/audit_cycle`}><King/> {this.props.auditCycle.client.name}</Link></li>
				...
				<div className="row" style={{fontSize:"110%"}}>
					...
					<div className="col-xs-6 col-md-2">
						<p>
							...
							<b>{ this.props.auditCycle.planned_audit ? this.props.auditCycle.planned_audit : 0 }</b>
						</p>
					</div>
				</div>
				<br/>
