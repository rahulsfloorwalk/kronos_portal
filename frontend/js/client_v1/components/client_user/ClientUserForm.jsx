...
export default class ClientUserForm extends React.Component{
	...
	onSubmit = (e) => {
		...
		promise.done(()=>{
			...
			hashHistory.push(`projects/${this.props.params.clientId}/client_user`);
		}).fail((err)=>{
			this.setState({
		...
		return (
			<Modal modalTitle={modalTitle} onClose={hashHistory.goBack}>
				<form onSubmit={this.onSubmit}>
					...
					<FormInput label="Password" type="password" value={this.state.form.password} name="password" onChange={this.fieldChanged} errors={this.state.errors.password} placeholder="leave blank to keep password unchanged"/>
