...
class CheckoutForm extends React.Component{
	...
	render(){
		...
		return(
			<div className="row">
				<div className="col-md-12 row well">
					<span onClick={this.props.toggleCheckout} style={{cursor:"pointer"}}><ArrowLeft/> Back</span>
					<h2 style={{marginBottom: "5%"}}>Checkout details</h2>
					...
					<form onSubmit={this.displayRazorpay}>
						...
						<div className="col-md-6">
							<FormInput type="text" className="form-control" label="PO Number" name="po_number" onChange={this.inputChanged} value={this.state.form.po_number} disabled={this.state.form_disable} errors={this.state.errors.po_number} />
						</div>
						<div className="col-md-6">
							<FormInput type="text" className="form-control" label="GSTIN Number" name="gstin_number" onChange={this.inputChanged} value={this.state.form.gstin_number} disabled={this.state.form_disable} errors={this.state.errors.gstin_number} />
						</div>
