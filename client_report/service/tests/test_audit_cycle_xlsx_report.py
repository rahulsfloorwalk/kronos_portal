...
from client_report.service.audit_cycle_xlsx_report import get_aggregate_report_with_filters
...
class AuditCycleXlsxReportTestCase(TestCase):
    ...
    def test_get_aggregate_report_with_filters(self):
        snapshot_name = "audit_cycle_xlsx.get_aggregate_report_with_filters_1.xlsx"
